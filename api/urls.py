...
from api.views import StatisticsListAPIView, ServiceListAPIView, ServiceDetailAPIView, StatisticsDetailAPIView, open_csv, CourseListAPIView, CourseDetailAPIView
